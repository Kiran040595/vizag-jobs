  ...
  return (
    <section>
      <div className="grid gap-4 md:grid-cols-2 lg:gap-6">
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6 lg:p-7">
          ...
          <Link
            to={employerHref}
            className="mt-5 inline-flex rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 lg:px-6 lg:py-3"
          >
            {employerLabel}
          </Link>
        </article>
