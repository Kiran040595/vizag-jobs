        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:ring-offset-2"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
